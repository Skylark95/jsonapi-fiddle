...
var _=m.substring(5)
w(l+S,h.substring(0,C),s,o),w(l+S+C,P,A(_,P),o),w(l+S+N,h.substring(N),s,o)}else o.push(l+S,m)}e.decorations=o}
...
return t.push([m,/^@[a-z_$][a-z_$@0-9]*/i,null],[h,/^(?:[@_]?[A-Z]+[a-z][A-Za-z_$@0-9]*|\w+_t\b)/,null],[y,/^[a-z_$][a-z_$@0-9]*/i,null],[m,new RegExp("^(?:0x[a-f0-9]+|(?:\\d(?:_\\d+)*\\d*(?:\\.\\d*)?|\\.\\d\\+)(?:e[+\\-]?\\d+)?)[a-z]*","i"),null,"0123456789"],[y,/^\\[\s\S]?/,null],[v,/^.[^\s\w\.$@\'\"\`\/\\]*/,null]),C(n,t)}function _(e,n,t){for(var r=/(?:^|\s)nocode(?:\s|$)/,a=/\r\n?|\n/,s=e.ownerDocument,i=s.createElement("li");e.firstChild;)i.appendChild(e.firstChild)
var l=[i]
...
e.appendChild(d)}var L={}
function T(n,t){for(var r=t.length;--r>=0;){var a=t[r]
L.hasOwnProperty(a)?e.console&&console.warn("cannot override language handler %s",a):L[a]=n}}function A(e,n){return e&&L.hasOwnProperty(e)||(e=/^\s*</.test(n)?"default-markup":"default-code"),L[e]}function E(n){var t=n.langExtension
...
n.sourceCode=a,n.spans=r.spans,n.basePos=0,A(t,a)(n),function(e){var n=/\bMSIE\s(\d+)/.exec(navigator.userAgent)
n=n&&+n[1]<=8
...
P.className=d[f+1]
var C=w.parentNode
C.replaceChild(P,w),P.appendChild(w),l<x&&(o[c+1]=w=S.createTextNode(s.substring(m,x)),C.insertBefore(w,P.nextSibling))}(l=m)>=x&&(c+=2),l>=R&&(f+=2)}}finally{y&&(y.style.display=v)}}(n)}catch(n){e.console&&console.log(n&&n.stack?n.stack:n)}}T(N({keywords:[r,s,i,l+o,u,c],hashComments:!0,cStyleComments:!0,multiLineStrings:!0,regexLiterals:!0}),["default-code"]),T(C([],[[y,/^[^<?]+/],["dec",/^<!\w[^>]*(?:>|$)/],[g,/^<\!--[\s\S]*?(?:-\->|$)/],["lang-",/^<\?([\s\S]+?)(?:\?>|$)/],["lang-",/^<%([\s\S]+?)(?:%>|$)/],[v,/^(?:<[%?]|[%?]>)/],["lang-",/^<xmp\b[^>]*>([\s\S]+?)<\/xmp\b[^>]*>/i],["lang-js",/^<script\b[^>]*>([\s\S]*?)(<\/script\b[^>]*>)/i],["lang-css",/^<style\b[^>]*>([\s\S]*?)(<\/style\b[^>]*>)/i],["lang-in.tag",/^(<\/?[a-z][^<>]*>)/i]]),["default-markup","htm","html","mxml","xhtml","xml","xsl"]),T(C([[y,/^[\s]+/,null," \t\r\n"],[x,/^(?:\"[^\"]*\"?|\'[^\']*\'?)/,null,"\"'"]],[["tag",/^^<\/?[a-z](?:[\w.:-]*\w)?|\/?>$/i],["atn",/^(?!style[\s=]|on)[a-z](?:[\w:-]*\w)?/i],["lang-uq.val",/^=\s*([^>\'\"\s]*(?:[^>\'\"\s\/]|\/(?=\s)))/],[v,/^[=<>\/]+/],["lang-js",/^on\w+\s*=\s*\"([^\"]+)\"/i],["lang-js",/^on\w+\s*=\s*\'([^\']+)\'/i],["lang-js",/^on\w+\s*=\s*([^\"\'>\s]+)/i],["lang-css",/^style\s*=\s*\"([^\"]+)\"/i],["lang-css",/^style\s*=\s*\'([^\']+)\'/i],["lang-css",/^style\s*=\s*([^\"\'>\s]+)/i]]),["in.tag"]),T(C([],[[x,/^[\s\S]+/]]),["uq.val"]),T(N({keywords:r,hashComments:!0,cStyleComments:!0,types:d}),["c","cc","cpp","cxx","cyc","m"]),T(N({keywords:"null,true,false"}),["json"]),T(N({keywords:s,hashComments:!0,cStyleComments:!0,verbatimStrings:!0,types:d}),["cs"]),T(N({keywords:a,cStyleComments:!0}),["java"]),T(N({keywords:c,hashComments:!0,multiLineStrings:!0}),["bsh","csh","sh"]),T(N({keywords:o,hashComments:!0,multiLineStrings:!0,tripleQuotedStrings:!0}),["cv","py"]),T(N({keywords:l,hashComments:!0,multiLineStrings:!0,regexLiterals:!0}),["perl","pl","pm"]),T(N({keywords:u,hashComments:!0,multiLineStrings:!0,regexLiterals:!0}),["rb"]),T(N({keywords:i,cStyleComments:!0,regexLiterals:!0}),["js"]),T(N({keywords:"all,and,by,catch,class,else,extends,false,finally,for,if,in,is,isnt,loop,new,no,not,null,of,off,on,or,return,super,then,throw,true,try,unless,until,when,while,yes",hashComments:3,cStyleComments:!0,multilineStrings:!0,tripleQuotedStrings:!0,regexLiterals:!0}),["coffee"]),T(C([],[[p,/^[\s\S]+/]]),["regex"])
var k=e.PR={createSimpleLexer:C,registerLangHandler:T,sourceDecorator:N,PR_ATTRIB_NAME:"atn",PR_ATTRIB_VALUE:x,PR_COMMENT:g,PR_DECLARATION:"dec",PR_KEYWORD:f,PR_LITERAL:m,PR_NOCODE:"nocode",PR_PLAIN:y,PR_PUNCTUATION:v,PR_SOURCE:b,PR_STRING:p,PR_TAG:"tag",PR_TYPE:h,prettyPrintOne:e.prettyPrintOne=function(e,n,t){var r=document.createElement("pre")
return r.innerHTML=e,t&&_(r,t,!0),E({langExtension:n,numberLines:t,sourceNode:r,pre:1}),r.innerHTML},prettyPrint:e.prettyPrint=function(n){function t(e){return document.getElementsByTagName(e)}for(var r=[t("pre"),t("code"),t("xmp")],a=[],s=0;s<r.length;++s)for(var i=0,l=r[s].length;i<l;++i)a.push(r[s][i])
r=null
var o=Date
...
b=w&&"pre"===w.substring(0,3)}var S=s.className.match(/\blinenums\b(?::(\d+))?/);(S=!!S&&(!S[1]||!S[1].length||+S[1]))&&_(s,S,b),E({langExtension:x,sourceNode:s,numberLines:S,pre:b})}}}u<a.length?setTimeout(t,250):n&&n()})()}}
